...
**Table of Contents**
  ...
  - [Step 3: Set up the Ground Truth Render Feature](#step-3)
  - [Step 4: Set up the Scene](#step-4)
...
### <a name="step-3">Step 3: Set up Ground Truth Render Feature</a>
...
### <a name="step-4">Step 4: Set up the Scene</a>
