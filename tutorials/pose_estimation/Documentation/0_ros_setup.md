...
The ROS workspace is now ready to accept commands! Return to [Part 3: Set up the Unity side](3_pick_and_place.md#step-3-set-up-the-unity-side) to continue the tutorial.