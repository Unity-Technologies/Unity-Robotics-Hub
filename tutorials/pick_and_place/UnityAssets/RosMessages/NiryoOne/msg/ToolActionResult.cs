...
{
    public class ToolActionResult : Message
    {
        public const string RosMessageName = "niryo_one_msgs/ToolActionResult";
        ...
        public ToolActionResult(Header header, GoalStatus status, ToolResult result)
        {
            this.header = header;
            this.status = status;
            this.result = result;
